...
// in simulator we redefine to format for IParkBR Developer console
...
{\
	NSString * exceptionName = [@"org.iparkbr." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.iparkbr";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIIParkBRNativeItemNone = -1, 
	UIIParkBRNativeItemSpinner = -2,
	UIIParkBRNativeItemProgressBar = -3,
	
	UIIParkBRNativeItemSlider = -4,
	UIIParkBRNativeItemSwitch = -5,
	UIIParkBRNativeItemMultiButton = -6,
	UIIParkBRNativeItemSegmented = -7,
	
	UIIParkBRNativeItemTextView = -8,
	UIIParkBRNativeItemTextField = -9,
	UIIParkBRNativeItemSearchBar = -10,
	
	UIIParkBRNativeItemPicker = -11,
	UIIParkBRNativeItemDatePicker = -12,
	
	UIIParkBRNativeItemInfoLight = -13,
	UIIParkBRNativeItemInfoDark = -14,
	
	UIIParkBRNativeItemDisclosure = -15,
	
	UIIParkBRNativeItemContactAdd = -16
};
